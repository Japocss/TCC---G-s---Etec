...
const ObstrucaoDicaScreen = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.iconContainer}>
        <Icon name="fire" size={200} color="#FF4500" />
      </View>
      ...
      <Text style={styles.title}>Evite Obstruções</Text>
      <Text style={styles.text}>
        Mantenha o detector livre de obstruções: Não cubra o detector com objetos ou materiais que possam bloquear a detecção de gás. Certifique-se de que o dispositivo está livre para detectar qualquer vazamento.
      </Text>
...
export default ObstrucaoDicaScreen;